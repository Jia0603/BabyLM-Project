...
import yaml
from interactive.reward import RandomRewardModel, Llama3RewardModel
from interactive.ppotrainer import CustomPPOTrainer
from trl import PPOConfig, AutoModelForCausalLMWithValueHead
from interactive.datasetbuilder import IMDBDatasetBuilder, DatasetCombiner, TinyStoriesDatasetBuilder, WritingPromptsDatasetBuilder, DeterministicPromptDatasetBuilder
from interactive.utils import LoggerFactory, load_yaml_config
...
def main(ppo_cfg, teacher_cfg):
    ...
    ppo_config = CustomPPOConfig(
        ...
        mini_batch_size=ppo_cfg.get("mini_batch_size", ppo_cfg.get("batch_size")),
    ...
    # reward_model = RandomRewardModel(config=teacher_cfg) # test
    ...
    trainer = CustomPPOTrainer(
        ...
        push_to_hub=True,  # 禁用自动上传到 Hugging Face
    )
